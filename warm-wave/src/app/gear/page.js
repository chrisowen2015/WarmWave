    ...
    return (
        <>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'center' }}>
                <Paper sx={{ width: '80%', backgroundImage: "url(/images/gear.jpeg)", backgroundRepeat: "no-repeat", backgroundPosition: "center", backgroundSize: "cover", }}>
                    <Box sx={{
                        padding: '2em',
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item md={4}>
                                ...
                                <Typography variant="p" component="p" sx={{ textAlign: "center" }}>
                                    Logic X <br />
                                    Ableton 10 Suite <br />
                                    Waves, Slate Digital, Soundtoys, Fab Filter, Ozone, Celemony, and more <br />
                                </Typography>
